...
export const DirectMessageView: FC<PropsWithChildren> = () => { 
  ...
  return (
    ...
    >
      <Stack flexDirection="row" alignItems="center" gap={2} padding="22px 10px">
        <IconButton 
        ...
        <Typography fontSize={20} fontWeight={700} color="grey.700">Mensajes destacados</Typography>
      </Stack>

      <Box width={1} height={1} display="flex" justifyContent="center" alignItems="center">
        <Typography color="grey.700" fontSize={16}>No hay mensajes destacados</Typography>
      </Box>
    </Box>
  );
};
...
import { Stack, IconButton, Typography, Divider, FormControl, RadioGroup, FormControlLabel, Radio } from '@mui/material';
  ...
  return (
    <>
      <Stack flexDirection="row" alignItems="center" gap={2} padding="10px">
        ...
        <Typography fontSize={20} fontWeight={700} color="grey.700">Hora de últ. vez y En Línea</Typography>
      </Stack>
      <Stack paddingX="20px" paddingY="10px" gap={3}>
        <Stack gap={1}>
          <Typography fontSize={16} fontWeight={600}>Quién puede ver mi hora de últ. vez</Typography>
          <FormControl>
            <RadioGroup
              defaultValue="todos"
              name="hora-ult-vez"
        ...
        <Divider />
        <Stack gap={1}>
          <Typography fontSize={16} fontWeight={600}>Quién puede ver cuándo estoy en linea</Typography>
          <FormControl>
            <RadioGroup
              defaultValue="todos"
              name="estoy-en-linea"

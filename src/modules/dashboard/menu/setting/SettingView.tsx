...
export const SettingView: FC<PropsWithChildren> = () => {
  const { currentView, position, handleChangeSetting } = useHandleChangeSettingView();
  ...
  const MenuViewCurrent = {
    ...
    [SettingCurrentViewEnum.PROFILE]: <ProfileView handleClickBack={handleActionProfile} />,
